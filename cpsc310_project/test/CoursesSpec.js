...
describe("CoursesSpec", function () {
    ...
    var allCourses = JSON.parse(fs.readFileSync('test/allcourses.json').toString('utf8'));
    var allInstructorsGrouped = JSON.parse(fs.readFileSync('test/allInstructorsGrouped.json').toString('utf8'));
    before(function () {
        this.timeout(10000);
        var coursesContent = fs.readFileSync('test/courses.zip').toString('base64');
        var roomsContent = fs.readFileSync('test/rooms.zip').toString('base64');
    });
    it("add and add, courses first", function () {
        ...
        return insightFacade.addDataset("courses", coursesContent).then(function () {
            ...
            return insightFacade.addDataset("rooms", roomsContent).then(function () {
                ...
                var database = fs.readFileSync("./src/controller/data.json", "utf8");
                var boolRooms = database.includes("rooms");
                var boolCourses = database.includes("courses");
                chai_1.expect(boolCourses).to.equal(true);
                chai_1.expect(boolRooms).to.equal(true);
            });
        });
    });
    it('8 should be able to sort on multiple keys in reverse order', function () {
    ...
    it('9 should be able to sort', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    { "IS": { "courses_id": "317" } },
    ...
    it('10 should be able to sort', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    { "IS": { "courses_id": "317" } },
    ...
    it('11 should be able to sort', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    { "IS": { "courses_id": "317" } },
    ...
    it('12 should return the correct result for all courses', function () {
        ...
        return insightFacade.performQuery({
            ...
            chai_1.expect(response.code).to.eq(200);
            chai_1.expect(response.body.result.length).to.eq(allCourses.result.length);
            for (var idx = 0; idx < response.body.result.length; idx++) {
                chai_1.expect(response.body.result[idx]).to.deep.eq(allCourses.result[idx]);
            }
        });
    });
    it('13 should return the correct result for all courses', function () {
        ...
        return insightFacade.performQuery({
            ...
            chai_1.expect(response.code).to.eq(200);
            chai_1.expect(response.body.result.length).to.eq(allInstructorsGrouped.result.length);
            for (var idx = 0; idx < response.body.result.length; idx++) {
                chai_1.expect(response.body.result[idx]).to.deep.eq(allInstructorsGrouped.result[idx]);
            }
        });
    });
    it('14 should return the correct result for a complex query', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "OR": [
                    {
    ...
    it('15 should return the correct reuslt for an instructor', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "IS": {
            ...
            chai_1.expect(response.body.result).to.not.be.empty;
            for (var _i = 0, _a = response.body["result"]; _i < _a.length; _i++) {
                var entry = _a[_i];
                chai_1.expect(entry.courses_instructor).to.equal('smulders, dave');
            }
        });
    });
    it('16 should return the correct result for courses with a lot of auditors', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "GT": {
                    "courses_audit": 5
            ...
            for (var _i = 0, _a = response.body["result"]; _i < _a.length; _i++) {
                var entry = _a[_i];
                chai_1.expect(entry.courses_audit).to.be.above(5);
            }
        });
    });
    it('17 should return the correct result for courses in a dept with an average between 70 and 80', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
            ...
            for (var _i = 0, _a = response.body["result"]; _i < _a.length; _i++) {
                var entry = _a[_i];
                chai_1.expect(entry.courses_avg).to.be.above(70);
                chai_1.expect(entry.courses_avg).to.be.below(80);
                chai_1.expect(entry.courses_dept).to.be.eq("biol");
            }
        });
    });
    it('18 should return the correct result for a simple query', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "GT": {
                    "courses_avg": 97
    ...
    it('20 should be able to find all the courses in a department not taught by a specific person', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('21 should produce the correct partial list', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "OR": [
    ...
    it('22 should produce the correct list of instructors', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "OR": [
                    { "IS": { "courses_instructor": "*pamela*" } }
    ...
    it('23 should be able to find all courses in a department with a partial name', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('24 should be able to find the year a course is offered in', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "GT": {
                    "courses_avg": 97
    ...
    it('25 should return the correct result for new sorted by', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "GT": {
                    "courses_avg": 80
            ...
            for (var _i = 0, _a = response.body["result"]; _i < _a.length; _i++) {
                var entry = _a[_i];
                if (lastEntry !== null) {
                    chai_1.expect(entry.courses_id).to.be.at.least(lastEntry.courses_id);
                    if (entry.courses_id === lastEntry.courses_id) {
                        chai_1.expect(entry.courses_avg).to.be.at.least(lastEntry.courses_avg);
                    }
                }
                lastEntry = entry;
            }
    ...
    it('26 should return the correct result for new sorted by rooms_results', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "GT": {
                    "courses_avg": 96
...
//# sourceMappingURL=CoursesSpec.js.map