...
describe("TestAdd", function () {
    ...
    it("empty dataset should return 400 error", function () {
        return insF.addDataset("courses", unP.getFromZip("courses1.zip").toString("base64")).then(function (value) {
            Util_1.default.test('Error: ' + value);
            chai_1.expect.fail();
        }).catch(function (err) {
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.deep.equal({
                "error": "Data could not be parsed!"
            });
        });
    });
    it("zip file but not data should return 400 error", function () {
        return insF.addDataset("courses", unP.getFromZip("STSR2395741.zip").toString("base64")).then(function (value) {
            Util_1.default.test('Error: ' + value);
            chai_1.expect.fail();
        }).catch(function (err) {
            chai_1.expect(err.code).to.equal(400);
    ...
    it("7z not a zip file should return 400 error", function () {
        return insF.addDataset("courses", unP.getFromZip("STSR2395741.7z").toString("base64")).then(function (value) {
            Util_1.default.test('Error: ' + value);
            chai_1.expect.fail();
        }).catch(function (err) {
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.deep.equal({ error: 'Not a zip file!' });
        });
    });
    it("OPTIONAL: data missing from zip return 204 after skipping bad parts", function () {
        return insF.addDataset("broken", unP.getFromZip("broken.zip").toString("base64")).then(function (value) {
    ...
    it("OPTIONAL:zip file with data but also other things should return 204 after skipping bad parts", function () {
        return insF.addDataset("mixed", unP.getFromZip("mixed.zip").toString("base64")).then(function (value) {
            Util_1.default.test('Value: ' + JSON.stringify(value));
            chai_1.expect(value.code).to.equal(204);
            chai_1.expect(value.body).to.deep.equal({ "Message": "Data Added!" });
        }).catch(function (err) {
    ...
    it("txt to zip file (corrupted) should return 400 error", function () {
        return insF.addDataset("courses", unP.getFromZip("zip.zip").toString("base64")).then(function (value) {
            Util_1.default.test('Error: ' + value);
            chai_1.expect.fail();
        }).catch(function (err) {
            chai_1.expect(err.code).to.equal(400);
    ...
    it("folder in folder zip should return 400 error", function () {
        return insF.addDataset("courses", unP.getFromZip("zip.zip").toString("base64")).then(function (value) {
            Util_1.default.test('Error: ' + value);
            chai_1.expect.fail();
        }).catch(function (err) {
    ...
    it("courses should return 204", function () {
        ...
        return insF.addDataset("courses", unP.getFromZip("courses.zip").toString("base64")).then(function (value) {
            ...
            Util_1.default.test('Stringified Value: ' + JSON.stringify(err));
            chai_1.expect.fail();
        });
    });
    ...
    it("rooms should return 400, destructured rooms.zip", function () {
        this.timeout(20000);
        return insF.addDataset("rooms", unP.getFromZip("rooms33.zip").toString("base64")).then(function (value) {
            chai_1.expect.fail();
            chai_1.expect(value.body).to.deep.equal({ "Message": "Data Added!" });
        }).catch(function (err) {
            Util_1.default.test('Error: ' + JSON.stringify(err));
    ...
    it("check query4, rooms invalid wildcard ***", function () {
        ...
        return insF.performQuery(query).then(function (err) {
            ...
            Util_1.default.test('Value: ' + JSON.stringify(value));
            Util_1.default.test('Stringified Value: ' + value.body);
            chai_1.expect(value.code).to.equal(400);
        });
    });
    ...
    it("check query10, rooms valid query (empty WHERE)", function () {
        ...
        return insf2.performQuery(query).then(function (value) {
            Util_1.default.test('Value: ' + value);
            Util_1.default.test('Stringified Value: ' + value.body);
            chai_1.expect(value.code).to.equal(200);
        }).catch(function (err) {
    ...
    it("check query3, rooms", function () {
        ...
        return insF.performQuery(query).then(function (value) {
            Util_1.default.test('Value: ' + value);
            Util_1.default.test('Stringified Value: ' + value.body);
            Util_1.default.test('Length: ' + Object.keys(JSON.stringify(value.body)).length);
    ...
    it("check query1 no dataset", function () {
        ...
        query = JSON.parse(query);
        return insF.performQuery(query).then(function (value) {
            chai_1.expect(value.code).to.equal(424);
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect(JSON.stringify(err)).to.equal('{"code":424,"body":{"error":"No datasets avaialable"}}');
        });
    });
    ...
    it("aresenic/cobalt 1", function () {
        this.timeout(20000);
        return insF.addDataset("rooms", unP.getFromZip("rooms.310.zip").toString("base64")).then(function (value) {
            chai_1.expect(value.code).to.equal(204);
        }).then(function () {
            return insF.removeDataset("rooms").then(function (valuex) {
                chai_1.expect(valuex.code).to.equal(204);
            }).then(function () {
                return insF.addDataset("rooms", unP.getFromZip("rooms.310.zip").toString("base64")).then(function (value) {
                    chai_1.expect(value.code).to.equal(204);
                }).then(function () {
    ...
    it("aresenic/cobalt 1.1", function () {
        ...
        return insF.addDataset("rooms", unP.getFromZip("rooms.310.zip").toString("base64")).then(function (value) {
            ...
            return insF2.addDataset("rooms", unP2.getFromZip("rooms.310.zip").toString("base64")).then(function (valuex) {
                Util_1.default.test('Value: ' + valuex);
                Util_1.default.test('Stringified Value: ' + JSON.stringify(valuex));
                chai_1.expect(valuex.code).to.equal(201);
            }).catch(function (err) {
                Util_1.default.test('Error: ' + err);
                chai_1.expect.fail();
            });
    ...
    it("aresenic/cobalt 2", function () {
        ...
        return insF.addDataset("rooms", unP.getFromZip("rooms.310.zip").toString("base64")).then(function (value) {
            ...
            return insF.addDataset("rooms", unP.getFromZip("rooms.zip").toString("base64")).then(function (valuex) {
                Util_1.default.test('Value: ' + valuex);
                Util_1.default.test('Stringified Value: ' + JSON.stringify(valuex));
                chai_1.expect(valuex.code).to.equal(201);
            }).catch(function (err) {
    ...
    it("aresenic/cobalt 3", function () {
        ...
        return insF.addDataset("courses", unP.getFromZip("courses.zip").toString("base64")).then(function (value) {
            ...
            return insF.addDataset("rooms", unP.getFromZip("rooms.310.zip").toString("base64")).then(function (valuex) {
                Util_1.default.test('Value: ' + valuex);
                Util_1.default.test('Stringified Value: ' + JSON.stringify(valuex));
                chai_1.expect(valuex.code).to.equal(201);
            }).catch(function (err) {
    ...
    it("aresenic/cobalt 4", function () {
        ...
        return insF.addDataset("courses", unP.getFromZip("courses.zip").toString("base64")).then(function (value) {
            ...
            return insF.addDataset("courses", unP.getFromZip("courses.zip").toString("base64")).then(function (valuex) {
                Util_1.default.test('Value: ' + valuex);
                Util_1.default.test('Stringified Value: ' + JSON.stringify(valuex));
                chai_1.expect(valuex.code).to.equal(201);
            }).catch(function (err) {
